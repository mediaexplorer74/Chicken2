...
// Type: Microsoft.CSharp.RuntimeBinder.ComInterop.ComInvokeBinder
...
namespace Microsoft.CSharp.RuntimeBinder.ComInterop
{
  internal sealed class ComInvokeBinder
  {
    ...
    private ParameterExpression DispParamsVariable
    {
      get
      {
        return ComInvokeBinder.EnsureVariable(ref this._dispParams, typeof (DISPPARAMS), "dispParams");
      }
    }
    ...
    private Expression GenerateTryBlock()
    {
      ...
      if (this._keywordArgNames.Length != 0)
      {
        ...
        expressionList.Add((Expression) Expression.Assign((Expression) Expression.Field((Expression) this.DispParamsVariable, typeof (DISPPARAMS).GetField("rgdispidNamedArgs")), (Expression) Expression.Call(typeof (UnsafeMethods).GetMethod("GetIdsOfNamedParameters"), (Expression) this.DispatchObjectVariable, (Expression) Expression.Constant((object) strArray), (Expression) this.DispIdVariable, (Expression) this.DispIdsOfKeywordArgsPinnedVariable)));
      }
      ...
      INVOKEKIND invokekind = !this._methodDesc.IsPropertyPut ? INVOKEKIND.INVOKE_FUNC | INVOKEKIND.INVOKE_PROPERTYGET : (!this._methodDesc.IsPropertyPutRef ? INVOKEKIND.INVOKE_PROPERTYPUT : INVOKEKIND.INVOKE_PROPERTYPUTREF);
    ...
    private Expression GenerateFinallyBlock()
    {
      List<Expression> expressionList = new List<Expression>()
      {
        (Expression) Expression.Call(typeof (UnsafeMethods).GetMethod("IUnknownRelease"), (Expression) this.DispatchPointerVariable)
      };
      int index = 0;
    ...
    private Expression MakeIDispatchInvokeTarget()
    {
      List<Expression> expressionList = new List<Expression>()
      {
        (Expression) Expression.Assign((Expression) this.DispIdVariable, (Expression) Expression.Property(this._method, typeof (ComMethodDesc).GetProperty("DispId")))
      };
      if (this._totalExplicitArgs != 0)
        expressionList.Add((Expression) Expression.Assign((Expression) Expression.Field((Expression) this.DispParamsVariable, typeof (DISPPARAMS).GetField("rgvarg")), (Expression) Expression.Call(typeof (UnsafeMethods).GetMethod("ConvertVariantByrefToPtr"), (Expression) VariantArray.GetStructField(this.ParamVariantsVariable, 0))));
      expressionList.Add((Expression) Expression.Assign((Expression) Expression.Field((Expression) this.DispParamsVariable, typeof (DISPPARAMS).GetField("cArgs")), (Expression) Expression.Constant((object) this._totalExplicitArgs)));
      if (this._methodDesc.IsPropertyPut)
      {
        expressionList.Add((Expression) Expression.Assign((Expression) Expression.Field((Expression) this.DispParamsVariable, typeof (DISPPARAMS).GetField("cNamedArgs")), (Expression) Expression.Constant((object) 1)));
        ...
        expressionList.Add((Expression) Expression.Assign((Expression) Expression.Field((Expression) this.DispParamsVariable, typeof (DISPPARAMS).GetField("rgdispidNamedArgs")), (Expression) Expression.Call(typeof (UnsafeMethods).GetMethod("ConvertInt32ByrefToPtr"), (Expression) this.PropertyPutDispIdVariable)));
      }
      else
        expressionList.Add((Expression) Expression.Assign((Expression) Expression.Field((Expression) this.DispParamsVariable, typeof (DISPPARAMS).GetField("cNamedArgs")), (Expression) Expression.Constant((object) this._keywordArgNames.Length)));
