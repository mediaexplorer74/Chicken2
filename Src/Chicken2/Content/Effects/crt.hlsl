...
float4 mainImage(float2 tex) : TARGET
{
    ...
    //if (xy.x < (step * 1))
    //    color += float4(0.2, 0, 0, 0);
    //else if (xy.x < (step * 2))
    //    color += float4(0.2, .05, 0, 0);
    //else if (xy.x < (step * 3))
    //    color += float4(0.2, 0.2, 0, 0);
    //else if (xy.x < (step * 4))
    //    color += float4(0, 0.2, 0, 0);
    //else if (xy.x < (step * 5))
    //    color += float4(0, 0, .2, 0);
    //else if (xy.x < (step * 6))
    //    color += float4(0, 0, .1, 0);
    //else
    //    color += float4(0.2, .1, 0.2, 0);
...
float4 PixelShaderFunction(float4 pos : SV_POSITION, float2 tex : TEXCOORD) : SV_TARGET
{
